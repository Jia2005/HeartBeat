...
function Happy() {
  ...
  const getColorScheme = () => {
    ...
    return {
      primary: 'from-yellow-200 via-pink-200 via-orange-200 to-purple-200',
  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .bg-cheerful-pattern {
          background-image: 
            radial-gradient(circle at 20% 20%, rgba(255, 193, 7, 0.3) 0%, transparent 40%),
            radial-gradient(circle at 80% 80%, rgba(255, 105, 180, 0.3) 0%, transparent 40%),
            radial-gradient(circle at 60% 30%, rgba(124, 58, 237, 0.2) 0%, transparent 40%),
            radial-gradient(circle at 30% 70%, rgba(34, 197, 94, 0.3) 0%, transparent 40%),
            radial-gradient(circle at 90% 20%, rgba(251, 146, 60, 0.3) 0%, transparent 40%),
